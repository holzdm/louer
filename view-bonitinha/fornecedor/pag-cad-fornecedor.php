...
<head>
  ...
  <title>LOUER | Seja um fornecedor</title>
    ...
    <div class="flex-grow container mx-auto px-4 py-10 md:py-16 flex justify-center">
      <div class="w-full max-w-2xl">
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-10">
          <h1 class="text-2xl md:text-3xl font-bold text-primary mb-3">Seja um fornecedor</h1>
          <p class="text-gray-600 mb-8">Junte-se ao LOUER e comece a disponibilizar espaços e itens.</p>

          <!-- Mensagem de erro -->
          <?php if (isset($_GET['msg'])): ?>
  <div class="fixed top-5 left-1/2 transform -translate-x-1/2 z-50 fade-in">
    <div class="bg-white border border-orange-300 text-orange-600 rounded-lg p-4 shadow-lg flex items-start max-w-md w-full">
      ...
      <div>
        <p class="font-medium text-sm">Algo deu errado!</p>
...
<?php endif; ?>
          ...
          <form action="../../control/CadFornecedor.php" method="post">
            <div class="space-y-5">
              ...
              <div>
                ...
                <input type="text" id="cep" name="cep" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="00000-000" required />
              </div>

              <!-- rua -->
              <div>
                <label for="rua" class="block text-sm font-medium text-gray-700 mb-1">Rua</label>
                <input type="text" id="rua" name="rua" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="Sua rua" required />
              </div>
              
              <!-- bairro -->
              <div>
                <label for="bairro" class="block text-sm font-medium text-gray-700 mb-1">Bairro</label>
                <input type="text" id="email" name="bairro" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="Seu bairro" required />
              </div>

              <!-- numero -->
              <div>
                <label for="nEnd" class="block text-sm font-medium text-gray-700 mb-1">Número</label>
                <input type="text" id="nEnd" name="nEnd" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="000" required />
              </div>

              <!-- complemento -->
              <div>
                <label for="complemento" class="block text-sm font-medium text-gray-700 mb-1">Complemento</label>
                <input type="text" id="complemento" name="complemento" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="Complemento" />
              </div>
          ...
          <p class="mt-6 text-center text-gray-600">
            <a href="../../view/cliente/pag-inicial-cliente.php" class="text-primary font-medium hover:underline">Cancelar</a>
          </p>
        </div>
      </div>
    </div>
